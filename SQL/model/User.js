...
var User = /** @class */ (function () {
    ...
    User.prototype.authenticate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e, _f, newUser, _g, _h, _j;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1: return [4 /*yield*/, _c.apply(_b, _d.concat([_k.sent()]))];
                    case 2:
                        _a._password = _k.sent();
                        _f = (_e = console).log;
                        return [4 /*yield*/, this.getRoleId()];
                    case 3:
                        _f.apply(_e, [_k.sent()]);
                        _h = (_g = sql_1.Model).runQuery;
                        _j = "INSERT INTO Users VALUES('" + this._userName + "','" + this._password + "', '";
                        return [4 /*yield*/, this.getRoleId()];
                    case 4: return [4 /*yield*/, _h.apply(_g, [_j + (_k.sent()) + "');"])];
                    case 5:
                        newUser = _k.sent();
                        return [2 /*return*/, newUser.rowsAffected[0] > 0];
                }
            });
        });
    };
    ...
    User.prototype.getId = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, sql_1.Model.runQuery("SELECT id FROM Users WHERE userName ='" + this.userName + "';")];
                    case 1: return [2 /*return*/, (_a.sent()).recordset[0].id];
                }
            });
        });
